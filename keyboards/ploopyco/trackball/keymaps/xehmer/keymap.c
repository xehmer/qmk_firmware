...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(KC_BTN4, G(KC_W), KC_BTN5, _______, MO(2)),
    [2] = LAYOUT(KC_BRIGHTNESS_DOWN, KC_MEDIA_PLAY_PAUSE, KC_BRIGHTNESS_UP, _______, _______),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (is_drag_scroll && keycode == DRAG_SCROLL && !record->event.pressed && overall_scroll_distance > BOINKOR_PLOOPY_RELEASE_ADHOC_DISTANCE) {
